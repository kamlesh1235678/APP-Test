...
class SalutationModelViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        try:
            ...
            message = "Salutation lsit fetch successfully"
            return response_handler(message=message, code=400 , data= {})
        
    def create(self, request, *args, **kwargs):
        try:
            response = super().create(request , *args , **kwargs)
            message = "Salutation create successfully"
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            message = "Salutation data retrived successfully"
            return response_handler(message= message , code= 200 , data=serializer.data)
        except NotFound:
            return response_handler(message="Salutation no found" , code = 400  , data = {})
    
    def destroy(self, request, *args, **kwargs):
        try:
            instance = self.get_object()
            self.perform_destroy(instance)
            message = "Salutation delete successfully"
            return response_handler(message= message , code = 200 , data= {})
        except:
            message = "Salutation no found"
            return response_handler(message= message , code = 400 , data= {})