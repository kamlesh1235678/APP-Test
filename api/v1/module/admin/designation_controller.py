...
class DesignationPagination(PageNumberPagination):
    page_size = 10 
    def get_paginated_response(self, data):
        total_items = self.page.paginator.count
        if not total_items:
            return Response({'message':'Designation no found' , 'code':400 , 'data': {} , 'extra':{}})
        if self.page_size:
...
class DesignationModelViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        try:
            ...
            message = "Designation lsit fetch successfully"
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            return response_handler(message="Designation not found" , code = 400 , data={})
