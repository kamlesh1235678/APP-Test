...
urlpatterns = [
  ...
  path('faculty-wise-class-filter/<int:faculty_id>', UpComingFacultyClassAPIView.as_view(), name='faculty-wise-class-filter'),
  ...
  path('id-card', IDCardView.as_view(), name='id-card'),
  path('hall-ticket/<int:student_id>/<int:term_id>/<str:type>', HallTicketWise.as_view(), name='hall-ticket'),
