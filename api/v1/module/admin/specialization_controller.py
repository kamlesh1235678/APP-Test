...
from api.v1.module.serializers.specialization_serializer import *
...
class SpecializationPagination(PageNumberPagination):
    page_size = 10 
    def get_paginated_response(self, data):
        total_items = self.page.paginator.count
        if not total_items:
            return Response({'message':'Specialization no found' , 'code':400 , 'data': [] , 'extra':{}})
        if self.page_size:
            total_page = math.ceil(total_items/self.page_size)
        message = "Specialization list fetch successfully"
...
class SpecializationModelViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            message = "Specialization create successfully"
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            message = "Specialization data retrived successfully"
            return response_handler(message= message , code= 200 , data=serializer.data)
        except NotFound:
            return response_handler(message="Specialization not found" , code = 400 , data={})
    ...
    def destroy(self, request, *args, **kwargs):
        try:
            ...
            message = "Specialization no found"
            return response_handler(message= message , code = 400 , data= {})