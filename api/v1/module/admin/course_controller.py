...
class CoursePagination(PageNumberPagination):
    ...
    def get_paginated_response(self, data):
        ...
        if not total_items:
            return Response({'message':'Course no found' , 'code':400 , 'data': {} , 'extra':{}})
        if self.page_size:
            total_page = math.ceil(total_items/self.page_size)
        message = "Course list fetch successfully"
...
class CourseModelViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        try:
            ...
            message = "Course lsit fetch successfully"
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            return response_handler(message= "Course no found" , code = 400 , data={})
